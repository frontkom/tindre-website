                  ...
                  <div className="absolute left-0 top-[calc(100%+10px)] z-20 w-[340px] max-w-[calc(100vw-3rem)] border border-black/10 bg-white p-4 shadow-[0_20px_60px_rgba(0,0,0,0.08)] sm:w-[380px]">
                    <DayPicker
                      ...
                      classNames={{
                        ...
                        selected:
                          "[&>button]:border-black [&>button]:bg-black [&>button]:text-white [&>button]:hover:border-black [&>button]:hover:bg-black",
                        disabled:
                      ...
                      {selectedDayAvailabilities.map((a) => {
                        ...
                        return (
                          <button
                            ...
                            className={[
                              "w-full cursor-pointer border-2 px-4 py-3 text-left text-sm font-semibold tracking-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/20",
                              isSelected
